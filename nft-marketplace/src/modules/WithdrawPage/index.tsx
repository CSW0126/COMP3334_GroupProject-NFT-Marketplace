...
const WithdrawPage = () => {
  const {withdrawFunds} = useNFTMarket();
    ...
    <div className="">
        {success ? 
            <div className="p-4 mb-4 text-sm text-green-700 bg-green-100 rounded-lg dark:bg-green-200 dark:text-green-800" role="alert">
                <span className="font-medium">Success!</span> Withdraw Successful. 
                {/* <a className="font-bold underline " href="">View Txh</a> */}
            </div>
            :
            null
        }
        ...
        {error ? 
            <div className="p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800" role="alert">
                <span className="font-medium">Error !</span> No Fund to Withdraw.
            </div>
            : null
        }
        {!loading ?         <button 
